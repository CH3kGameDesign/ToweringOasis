...
public class AIRanged : MonoBehaviour {
    ...
    public GameObject FlameAttackRange;
    ...
    public void DecideMove()
    {
        ...
        if (distanceToPlayers[closestPlayer] <= movementSpaces + 4)
        {
                ...
                if (i != closestPlayer)
                {
                    ...
                    if (player1.m_v2GridCoordinate.x == player2.m_v2GridCoordinate.x || player1.m_v2GridCoordinate.y == player2.m_v2GridCoordinate.y)
                    {
                        ...
                        if (DestinationList.Count < 9)
                        {
                            ...
                            if (path.Count <= 8)
                            {
                                Destination = path[movementSpaces].m_v3WorldPosition;
                                if (DebugTrue)
    ...
    private void FlameAttack()
    {
        ...
        */
        ...
        FlameAttackRange.SetActive(true);
        FlameAttackRange.GetComponent<AIAttackRange>().CheckAttack();
    ...
    {
        FlameAttackRange.GetComponent<AIAttackRange>().EndAttack();
        FlameAttackRange.SetActive(false);
    }
